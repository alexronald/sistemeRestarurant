...
$dni = $_POST['dni'];
$sql = "INSERT INTO cosinero(nombre,apellido1,apellido2,dni)VALUES('$nombre','$apellido1','$apellido2','$dni');";
...
$sql = "UPDATE cosinero SET nombre='$nombre',apellido1='$apellido1',apellido2='$apellido2',dni='$dni' WHERE id = $id";
$resultado = $conexion->query($sql);
$nombre = "";
$apellido1 = "";
$apellido2 = "";
...
$id = $_POST['codigo'];
$sql = "DELETE FROM cosinero WHERE id = $id";
$resultado = $conexion->query($sql);
$id='';
}
}
...
<table>
	<thead>
	<tr>
		<th><h2 align="center">Registrar cosinero</h2></th>
		<th><h2 align="center">Lista cosinero</h2></th>
	</tr>
	</thead>
	<tbody>
		<tr>
		<td>
		<form action="cosinero.php" method="POST">
		<?php
